...
pub(crate) fn particles_to_grid_solids(
    grid: Res<Grid>,
    ...
    particles_solid
        .par_iter_mut()
        .for_each_mut(|(position, mass, _, pp, mut mmc)| {
...
pub(crate) fn particles_to_grid_fluids(
    world: Res<WorldState>,
    grid: Res<Grid>,
    ...
    particles_fluid.par_iter_mut().for_each_mut(
